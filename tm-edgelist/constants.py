...
# CDM_20 record type constants
CDM20_TYPE_EVENT = 'com.bbn.tc.schema.avro.cdm20.Event'
CDM20_TYPE_FILE = 'com.bbn.tc.schema.avro.cdm20.FileObject'
CDM20_TYPE_SOCK = 'com.bbn.tc.schema.avro.cdm20.NetFlowObject'
CDM20_TYPE_SUBJECT = 'com.bbn.tc.schema.avro.cdm20.Subject'
CDM20_TYPE_SRCSINK = 'com.bbn.tc.schema.avro.cdm20.SrcSinkObject'
CDM20_TYPE_PIPE = 'com.bbn.tc.schema.avro.cdm20.UnnamedPipeObject'
CDM20_TYPE_PRINCIPAL = 'com.bbn.tc.schema.avro.cdm20.Principal'
CDM20_TYPE_TAG = 'com.bbn.tc.schema.avro.cdm20.ProvenanceTagNode'
CDM20_TYPE_STARTMARKER = 'com.bbn.tc.schema.avro.cdm20.StartMarker'
CDM20_TYPE_TIMEMARKER = 'com.bbn.tc.schema.avro.cdm20.TimeMarker'
CDM20_TYPE_HOST = 'com.bbn.tc.schema.avro.cdm20.Host'
CDM20_TYPE_KEY = 'com.bbn.tc.schema.avro.cdm20.RegistryKeyObject'
CDM20_TYPE_MEMORY = 'com.bbn.tc.schema.avro.cdm20.MemoryObject'
CDM20_TYPE_ENDMARKER = 'com.bbn.tc.schema.avro.cdm20.EndMarker'
CDM20_TYPE_UNITDEPENDENCY = 'com.bbn.tc.schema.avro.cdm20.UnitDependency'

# CDM_20 UUID constant
CDM20_UUID = 'com.bbn.tc.schema.avro.cdm20.UUID'
...
#     print(
#         "\x1b[6;30;42m[+]\x1b[0m setting up database {}.db in current directory...".format(fn))
#     return db
